...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-card/50 backdrop-blur-sm mt-12 sm:mt-16 lg:mt-20">
      <div className="container mx-auto px-4 py-8 sm:py-10 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">The premier NFT marketplace on Sui network</p>
          </div>

          {/* Navigation */}
          <div>
            <h3 className="text-sm sm:text-base font-semibold text-foreground mb-3 sm:mb-4">Navigation</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/mint" className="text-xs sm:text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Create
                </Link>
              </li>
              <li>
                <Link to="/my-nfts" className="text-xs sm:text-sm text-muted-foreground hover:text-foreground transition-colors">
                  My Collection
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.github.com/Ritvent" className="p-2 rounded-lg hover:bg-primary/10 transition-colors">
                <Github className="w-4 h-4 sm:w-5 sm:h-5 text-muted-foreground hover:text-primary" />
              </a>
        ...
        <div className="border-t border-border pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <p className="text-xs sm:text-sm text-muted-foreground text-center sm:text-left">© {currentYear} OpenSUI. All rights reserved.</p>
